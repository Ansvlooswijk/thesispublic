...
# x = model0.addVar(name='x', lb=0.0, ub=1.0, vtype = GRB.BINARY)  
# zeta = model0.addVar(name='zeta', lb=0.0, vtype = GRB.CONTINUOUS) 
# model0.setObjective(x+zeta)
# model0.optimize 
...
model.addConstr(-x*3.75 + 3.75 <= zeta) #first cut
